  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        !isMacOSTheme &&
          "flex h-9 w-full items-center justify-between whitespace-nowrap rounded-md border border-input bg-transparent px-3 py-2 text-sm retro-button-border ring-offset-background placeholder:text-muted-foreground focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
        // macOS theme classes
        isMacOSTheme &&
